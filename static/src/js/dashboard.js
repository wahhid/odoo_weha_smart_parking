odoo.define('weha_smart_parking.Dashboard', function (require) {
"use strict";
...
var ParkingDashboard = AbstractAction.extend({
    template: 'ParkingDashboard',
    events: {
    ...
    init: function(parent, context) {
        ...
        this.dashboards_templates = ['ParkingTransaction'];
    ...
    render_dashboards: function() {
        var self = this;
            _.each(this.dashboards_templates, function(template) {
                self.$('.o_parking_dashboard').append(QWeb.render(template, {widget: self}));
            });
    },
